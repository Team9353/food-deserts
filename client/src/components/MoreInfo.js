...
const MoreInfo = () => (
    <div>
        ...
        <Segment color='green'>
            ...
            - Ineffective food security interventions can end up becoming
            another barrier to food security.

            <br></br>
            <br></br>

            - Food assistance programs alone have not been effective
            because they do not address the problem of food insecurity
            at the level of its most widely agreed upon cause: poverty.

            <br></br>

            <h3>What Is The Breadth Of Food Insecurity?</h3>
            ...
            <h3>What Are The Effects Of Food Insecurity?</h3>

            - People living in food deserts are also more likely to be
            ...
            - Food insecurity directly causes physical health problems because
            malnutrition decimates immunity to diseases and toxic substances.

            <br></br>
            <br></br>

            - The damage of food insecurity is compounded for children and
        ...
        <Segment color='green'>This web app was created by Georgia Tech
            Junior Design
            team 9353. The team consists of several members, including
